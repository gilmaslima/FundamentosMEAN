...
{
    /// <summary>
    /// UserControl do Box Novo Pacote
    /// </summary>
    public partial class NovoPacote : BaseUserControl
    {
        #region [ Controles ]
        ...
        private Int32 Consultar(Guid guid, BuscarDados dados, Int32 pagina, Int32 tamanhoPagina)
        {
            ...
            var registros = default(List<WAExtratoServicosServico.NovoPacote>);
            ...
            using (Logger log = Logger.IniciarLog("Relatório de Serviços - NovoPacote"))
            {
                try
                {
                    using (var contexto = new ContextoWCF<HISServicoWA_Extrato_ServicosClient>())
                        registros = contexto.Cliente.ConsultarNovoPacote(
