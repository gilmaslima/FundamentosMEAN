...
{
    /// <summary>
    /// UserControl do Box Avs
    /// </summary>
    public partial class Avs : BaseUserControl
    {
        #region [ Controles ]
        ...
        private Int32 Consultar(Guid guid, BuscarDados dados, Int32 pagina, Int32 tamanhoPagina)
        {
            ...
            var registros = default(List<WAExtratoServicosServico.Avs>);
            ...
            using (Logger log = Logger.IniciarLog("Relatório de Serviços - Avs"))
            {
                try
                {
                    using (var contexto = new ContextoWCF<HISServicoWA_Extrato_ServicosClient>())
                        registros = contexto.Cliente.ConsultarAvs(
