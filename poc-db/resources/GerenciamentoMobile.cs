...
namespace Redecard.PN.Boston.Sharepoint.WebParts.GerenciamentoMobile
{
    ...
    public class GerenciamentoMobile : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/Redecard.PN.Boston.Sharepoint.WebParts/GerenciamentoMobile/GerenciamentoMobileUserControl.ascx";
