...
{
	/// <summary>
	/// Disponibiliza o controle de download Doc.
	/// </summary>
	internal class MenuAcaoDownloadDoc : WebControl, INamingContainer, IPostBackEventHandler
    {
        public MenuAcaoDownloadDoc(EventHandler click, String clientClick)
            : base(HtmlTextWriterTag.A)
        {
            this.ID = "btnDownloadDoc";
            this.Click = click;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            String urlImagem = "/sites/fechado/Style%20Library/pt-br/Redecard/Img/redeareafechada-facelift/word-file.png";
            String texto = "download em DOC";
