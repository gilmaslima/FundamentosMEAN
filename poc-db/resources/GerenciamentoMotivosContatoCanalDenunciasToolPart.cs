...
{
    public class GerenciamentoMotivosContatoCanalDenunciasToolPart : ToolPart
    {
        ...
        public GerenciamentoMotivosContatoCanalDenunciasToolPart(IValidacao<string> validador)
        {
            if (validador == null)
        ...
        public override void ApplyChanges()
        {
            ...
            {
                this.WebPart.Page.ClientScript.RegisterStartupScript(typeof(Page), "_erroValidacaoMotivosContato", string.Format("<script>alert('{0}');</script>", MontadorMensagemErroUtil.Montar(resultadoValidacao, GerenciamentoMotivosContatoCanalDenunciasToolPart.cabecalhoInstrucaoCorrecao)));
                this.CancelChanges();
            }
        }
        ...
        /// (Parent Container)
        /// </summary>
        private FormularioCanalDenuncias WebPart
        {
            get
            {
                return this.ParentToolPane.SelectedWebPart as FormularioCanalDenuncias;
            }
        }
        ...
        protected override void CreateChildControls()
        {
            ...
            this.ltlInstrucao = new LiteralControl(GerenciamentoMotivosContatoCanalDenunciasToolPart.mensagemInstrucao);
