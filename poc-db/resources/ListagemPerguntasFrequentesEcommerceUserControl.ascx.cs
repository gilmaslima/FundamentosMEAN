...
{
    public partial class ListagemPerguntasFrequentesEcommerceUserControl : UserControl
    {
        #region Variáveis
        ...
        /// </summary>
        private ListagemPerguntasFrequentesEcommerce WebPart
        {
            get
            {
                return this.Parent as ListagemPerguntasFrequentesEcommerce;
            }
        }
        ...
        private IList<string> ObterAreas()
        {
            ...
            try
            {
                using (var repository = SharePointServiceLocator.GetCurrent().GetInstance<IRepository<DTOPerguntaFrequenteEcommerce, PerguntasFrequentesEcommerceItem>>())
                {
        ...
        */
        ...
        /// Obtém ordenado por ordem decrescente de cadastro
        /// </summary>
        private IList<DTOPerguntaFrequenteEcommerce> ObterPerguntasFrequentes()
        {
            IList<DTOPerguntaFrequenteEcommerce> perguntasFrequentes = null;

            if (!this.IgnorarFiltros)
            {
                //Caso nenhum filtro tenha sido informado, evita a busca no repositório e retorna lista vazia
                if (!this.AlgumFiltroInformado)
                    return new List<DTOPerguntaFrequenteEcommerce>(0);
        ...
        /// </summary>
        /// <returns></returns>
        private ListaPaginada<DTOPerguntaFrequenteEcommerce> ObterPaginaPerguntasFrequentes()
        {
            return new ListaPaginada<DTOPerguntaFrequenteEcommerce>(this.ObterPerguntasFrequentes(), this.Paginador.Pagina, this.ItensPorPagina);
        }
        ...
        private void CarregarPerguntasFrequentes()
        {
            if (this.PaginacaoHabilitada)
            {
                ...
                ListaPaginada<DTOPerguntaFrequenteEcommerce> perguntasFrequentes = this.ObterPaginaPerguntasFrequentes();
        ...
        private void PopularPerguntasFrequentes(IEnumerable<DTOPerguntaFrequenteEcommerce> perguntasFrequentes)
        {
