...
{
    /// <summary>
    /// Classe para implementação do CampoNovoAcesso - Agencia
    /// </summary>
    public class CampoAgencia : ICampoNovoAcesso
    {
        /// <summary>
        /// Construtor
        /// </summary>
        /// <param name="controle">Instância do controle CampoNovoAcesso</param>
        public CampoAgencia(CampoNovoAcesso controle) : base(controle) { }
