...
[assembly: TagPrefix("Rede.PN.Eadquirencia.Sharepoint.Controles", "Rede")]
namespace Rede.PN.Eadquirencia.Sharepoint.Controles
{
    /// <summary>
    ...
    public class MultiSelectDropDown : CheckBoxList, IPostBackEventHandler
    {
        ...
        protected override void OnPreRender(EventArgs e)
        {
            ...
            if (!Page.ClientScript.IsClientScriptIncludeRegistered("MultiSelectDropDownScript"))
            {
                Page.ClientScript.RegisterClientScriptInclude(this.GetType(),
                    ...
                    Page.ClientScript.GetWebResourceUrl(this.GetType(), "Rede.PN.Eadquirencia.Sharepoint.Custom.multiselect-dropdown.js"));
            }
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            writer.RenderBeginTag(HtmlTextWriterTag.Div);
            {
                ...
                writer.AddAttribute(HtmlTextWriterAttribute.Style, String.Concat("display:none; "));
                writer.RenderBeginTag(HtmlTextWriterTag.Div);
                {
