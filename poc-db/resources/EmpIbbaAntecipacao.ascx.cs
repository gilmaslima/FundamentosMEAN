...
{
    /// <summary>
    /// HomePage Segmentada EMP/IBBA - Box de Antecipação de Vendas
    /// </summary>
    public partial class EmpIbbaAntecipacao : BaseUserControl
    {
        #region [ Controles ]
        ...
        /// </summary>
        public ConteudoEditavel ucConteudoAviso;
        ...
        /// Se não está logado, exibe, pois pode e
        /// </summary>
