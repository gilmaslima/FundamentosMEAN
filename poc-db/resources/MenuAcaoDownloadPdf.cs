...
{
	/// <summary>
	/// Disponibiliza o controle de download PDF.
	/// </summary>
	internal class MenuAcaoDownloadPdf : WebControl, INamingContainer, IPostBackEventHandler
    {
        public MenuAcaoDownloadPdf(EventHandler click, String clientClick)
            : base(HtmlTextWriterTag.A)
        {
            this.ID = "btnDownloadPdf";
            this.Click = click;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            String urlImagem = "/sites/fechado/Style%20Library/pt-br/Redecard/Img/redeareafechada-facelift/pdf.png";
            String texto = "download em PDF";
