...
namespace Redecard.PN.DadosCadastrais.SharePoint.WPAberto.ConfirmacaoPositivaRecuperacao
{
    ...
    public class ConfirmacaoPositivaRecuperacao : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/Redecard.PN.DadosCadastrais.SharePoint.WPAberto/ConfPosRecuperacao/ConfPosRecuperacaoUserControl.ascx";
        ...
        protected override void CreateChildControls()
        {
            ...
            if (control != null)
            {
                ((ConfirmacaoPositivaRecuperacaoUserControl)control).WebPartRecuperacao = this;
            }
