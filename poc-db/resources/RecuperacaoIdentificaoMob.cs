...
namespace Rede.PN.DadosCadastraisMobile.SharePoint.WPMobile.RecuperacaoIdentificaoMob
{
    ...
    public class RecuperacaoIdentificaoMob : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/Rede.PN.DadosCadastraisMobile.SharePoint.WPMobile/RecuperacaoIdentificaoMob/RecuperacaoIdentificaoMobUserControl.ascx";
        ...
        protected override void CreateChildControls()
        {
            ...
            if (control != null)
            {
                ((RecuperacaoIdentificaoMobUserControl)control).WebPartRecuperacao = this;
            }
