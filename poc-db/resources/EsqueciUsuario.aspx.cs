...
namespace Redecard.PN.DadosCadastrais.SharePoint.Layouts.DadosCadastrais
{
    ...
    /// </summary>
    public class EsqueciUsuario : ApplicationPageBaseAnonima
    {
        #region Controles
        /// <summary>
        /// 
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                ltUrl.Text = Util.BuscarUrlRedirecionamento("/_layouts/DadosCadastrais/EsqueciUsuario.aspx", SPUrlZone.Internet);
            }
