...
{
	/// <summary>
	/// Disponibiliza o controle de download CSV.
	/// </summary>
	internal class MenuAcaoDownloadCsv : WebControl, INamingContainer, IPostBackEventHandler
    {
        public MenuAcaoDownloadCsv(EventHandler click, String clientClick)
            : base(HtmlTextWriterTag.A)
        {
            this.ID = "btnDownloadCsv";
            this.Click = click;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            String urlImagem = "/sites/fechado/Style%20Library/pt-br/Redecard/Img/redeareafechada-facelift/CSV.png";
            String texto = "download em CSV";
