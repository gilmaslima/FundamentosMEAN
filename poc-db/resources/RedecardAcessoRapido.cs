...
namespace Redecard.Portal.Fechado.WebParts.RedecardAcessoRapido
{
    ...
    public class RedecardAcessoRapido : WebPart
    {
        ...
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/Redecard.Portal.Fechado.WebParts/RedecardAcessoRapido/RedecardAcessoRapidoUserControl.ascx";
