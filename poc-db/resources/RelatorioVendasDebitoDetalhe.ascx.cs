...
{
    /// <summary>
    /// Turquia - Relatório Vendas Débito - Detalhe.
    /// </summary>
    public partial class RelatorioVendasDebitoDetalhe : BaseUserControl, IRelatorioHandler
    {
        #region [Propriedades]
        ...
        /// Totalizador
        /// </summary>
        private TotalVendasDebitoPorDiaBandeira Totalizador
        {
            get
            {
                return ViewState.Count > 0 && ViewState["Totalizador"] != null ?
                    (TotalVendasDebitoPorDiaBandeira)ViewState["Totalizador"] : new TotalVendasDebitoPorDiaBandeira();
            }
        ...
        /// </summary>
        private List<ResumoVendasDebitoPorDia> Registros
        {
            get
            {
                return ViewState.Count > 0 && ViewState["Registros"] != null ?
                    (List<ResumoVendasDebitoPorDia>)ViewState["Registros"] : new List<ResumoVendasDebitoPorDia>();
            }
        ...
        protected void rptDados_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
            {
                ...
                ResumoVendasDebitoPorDia dataItem = e.Item.DataItem as ResumoVendasDebitoPorDia;
                ...
                PlaceHolder phdResumoVendas = (PlaceHolder)trDetalhe.FindControl("phResumoVendas");
                ...
                phdResumoVendas.Controls.Add(base.ObterHyperLinkResumoVenda("D", dataItem.NumeroResumoVenda, dataItem.NumeroEstabelecimento, dataItem.DataVenda.Value));
            ...
            using (Logger log = Logger.IniciarLog(NomeOperacao))
            {
                try
                {
                    ...
                    using (var contexto = new ContextoWCF<HisServicoWaExtratoValoresConsolidadosVendasClient>())
                    {
                        ...
                        var registros = default(List<ResumoVendasDebitoPorDia>);
                        var totalizador = default(TotalVendasDebitoPorDiaBandeira);
                        ...
                        if (tipoConsulta == "detalhe")
                        {
                            ...
                            contexto.Cliente.ConsultarRelatorioVendasDebitoPorDia(
                        ...
                        else if (tipoConsulta == "verTodos")
                        {
                            ...
                            contexto.Cliente.ConsultarRelatorioVendasDebitoPorDiaTodos(
                                GuidPesquisaTotalizador(),
                                GuidPesquisa(),
        ...
        private void ConsultarCompleto(BuscarDados dadosBusca)
        {
            using (Logger log = Logger.IniciarLog(NomeOperacao))
            {
                try
                {
                    ...
                    var statusRelatorio = default(StatusRetorno);
                    var statusTotalizador = default(StatusRetorno);
                    var registros = new List<ResumoVendasDebitoPorDia>();
                    var registrosPagina = default(List<ResumoVendasDebitoPorDia>);
                    var totalizador = default(TotalVendasDebitoPorDiaBandeira);
                    ...
                    if (tipoConsulta.CompareTo("detalhe") == 0)
                    {
                        ...
                        using (var contexto = new ContextoWCF<HisServicoWaExtratoValoresConsolidadosVendasClient>())
                        {
                            ...
                            totalizador = contexto.Cliente.ConsultarTotalVendasDebitoPorDiaBandeira(
                                out statusTotalizador,
                                GuidPesquisaTotalizador(),
                                dataVenda,
                                numeroEstabelecimento);
                        ...
                        do
                        {
                            ...
                            using (var contexto = new ContextoWCF<HisServicoWaExtratoValoresConsolidadosVendasClient>())
                            {
                                registrosPagina = contexto.Cliente.ConsultarResumoVendasDebitoPorDia(
                                    GuidPesquisa(),
                                    registroInicial,
                                    tamanhoPagina,
                    ...
                    else if (tipoConsulta.CompareTo("verTodos") == 0)
                    {
                        ...
                        {
                            //Consulta o totalizador do relatório
                            totalizador = contexto.Cliente.ConsultarTotalVendasDebitoPorDiaBandeiraTodos(
                                out statusTotalizador,
                                GuidPesquisaTotalizador(),
                                GuidPesquisaPvDataVenda,
                                dataInicio,
                        ...
                        do
                        {
                            ...
                            using (var contexto = new ContextoWCF<HisServicoWaExtratoValoresConsolidadosVendasClient>())
                            {
                                registrosPagina = contexto.Cliente.ConsultarResumoVendasDebitoPorDiaTodos(
                                    GuidPesquisa(),
                                    GuidPesquisaPvDataVenda,
                                    registroInicial,
                                    tamanhoPagina,
