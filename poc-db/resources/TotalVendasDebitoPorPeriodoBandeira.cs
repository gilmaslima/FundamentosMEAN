...
{
    /// <summary>
    /// Turquia - Total de vendas débito por período retornando as bandeiras.
    /// </summary>
    [DataContract]
    public class TotalVendasDebitoPorPeriodoBandeira : TotalVendasBase
    {
        /// <summary>
        ...
        public static TotalVendasDebitoPorPeriodoBandeira FromDto(DTO.TotalVendasDebitoPorPeriodoBandeira dto)
        {
            Mapper.CreateMap<DTO.TotalVendasDebitoPorPeriodoBandeira, TotalVendasDebitoPorPeriodoBandeira>();
            Mapper.CreateMap<DTO.TotalVendasPorBandeira, TotalVendasPorBandeira>();
            return Mapper.Map<DTO.TotalVendasDebitoPorPeriodoBandeira, TotalVendasDebitoPorPeriodoBandeira>(dto);
        }
    }
}
