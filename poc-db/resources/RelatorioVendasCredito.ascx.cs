...
namespace Redecard.PN.Extrato.SharePoint.ControlTemplates.ExtratoV2.ValoresConsolidados
{
    ...
    /// </summary>
    public partial class RelatorioVendasCredito : BaseUserControl, IRelatorioHandler
    {
        #region [Propriedades]
        ...
        /// Totalizador
        /// </summary>
        private TotalVendasCreditoPorPeriodoBandeira Totalizador
        {
            get
            {
                return ViewState.Count > 0 && ViewState["Totalizador"] != null ?
                    (TotalVendasCreditoPorPeriodoBandeira)ViewState["Totalizador"] : new TotalVendasCreditoPorPeriodoBandeira();
            }
        ...
        /// </summary>
        private List<VendasCreditoPorDiaPv> Registros
        {
            get
            {
                return ViewState.Count > 0 && ViewState["Registros"] != null ?
                    (List<VendasCreditoPorDiaPv>)ViewState["Registros"] : new List<VendasCreditoPorDiaPv>();
            }
        ...
        protected void rptDados_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                VendasCreditoPorDiaPv dataItem = e.Item.DataItem as VendasCreditoPorDiaPv;
        ...
        {
            //Altera os dados da busca para exibir o relatório de crédito - detalhe.
            BuscarDados dados = ObterBuscarDados();
            dados.IDTipoVenda = Convert.ToInt32(TipoVenda.Credito);
            ...
            {
                VendasCreditoPorDiaPv dataItem = Registros.ToArray()[index.Value];
            ...
            using (Logger log = Logger.IniciarLog(NomeOperacao))
            {
                try
                {
                    ...
                    using (var contexto = new ContextoWCF< HisServicoWaExtratoValoresConsolidadosVendasClient>())
                    {
                        ...
                        List<VendasCreditoPorDiaPv> registros;
                        TotalVendasCreditoPorPeriodoBandeira totalizador;

                        contexto.Cliente.ConsultarRelatorioVendasCreditoPorPeriodo(
