...
namespace Rede.PN.AtendimentoDigital.Core.Config.GeradorObjeto
{
	...
	/// </summary>
	[ConfigurationCollection(typeof(Objeto))]
	public class ColecaoObjeto : ConfigurationElementCollection
	{
		#region Propriedades
		...
		/// </summary>
		private String nomePropriedade = "objeto";

		/// <summary>
		/// Obtém o tipo da <see cref="ColecaoObjeto"/>.
		/// </summary>
		...
		public Objeto this[Int32 idx]
		{
			get
			{
				return (Objeto)BaseGet(idx);
			}
		}
