...
{
	/// <summary>
	/// Disponibiliza o controle de Imprimir.
	/// </summary>
	internal class MenuAcaoImprimir : WebControl, INamingContainer, IPostBackEventHandler
    {
        public MenuAcaoImprimir(EventHandler click, String clientClick)
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            String urlImagem = "/sites/fechado/Style%20Library/pt-br/Redecard/Img/redeareafechada-facelift/print.png";
