...
{
    public partial class FacaSuaVendaComprovanteCredito : PageBaseDataCash
    {
        ...
        private void ExibirComprovante(Modelo.TransacaoVenda transacao)
        {
            ...
            {
                ltrCET.Text = ((Modelo.TransacaoVendaCreditoParceladoEmissor)transacao).Taxa.CETFormatado;
                ltrTaxaJuros.Text = ((Modelo.TransacaoVendaCreditoParceladoEmissor)transacao).Taxa.JurosFormatado;
                ltrValorParcelaJuros.Text = ((Modelo.TransacaoVendaCreditoParceladoEmissor)transacao).Taxa.ValorParcelaJurosFormatado;
                ltrValorTotalJuros.Text = ((Modelo.TransacaoVendaCreditoParceladoEmissor)transacao).Taxa.ValorTotalJurosFormatado;
