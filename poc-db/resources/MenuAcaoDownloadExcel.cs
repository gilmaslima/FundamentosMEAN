...
{
	/// <summary>
	/// Disponibiliza o controle de download excel.
	/// </summary>
	internal class MenuAcaoDownloadExcel : WebControl, INamingContainer, IPostBackEventHandler
    {
        public MenuAcaoDownloadExcel(EventHandler click, String clientClick)
            : base(HtmlTextWriterTag.A)
        {
            this.ID = "btnDownloadExcel";
            this.Click = click;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            String urlImagem = "/sites/fechado/Style%20Library/pt-br/Redecard/Img/redeareafechada-facelift/excel.png";
            String texto = "download em Excel";
