...
{
    /// <summary>
    /// Este componente publica a classe BloquearCartaoEnvio, que expõe propriedades para manipular dados de envio de bloqueio de cartão.
    /// </summary>
    [DataContract]
    public class BloquearCartaoEnvio
    {
        [DataMember]
