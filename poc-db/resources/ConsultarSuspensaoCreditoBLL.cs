...
namespace Redecard.PN.Extrato.Negocio
{
    ...
    /// </summary>
    public class ConsultarSuspensaoCreditoBLL : AbstractPesquisaComTotalizadorBLL<ConsultarSuspensaoEnvioDTO, BasicDTO, ConsultarSuspensaoTotaisRetornoDTO>
    {
        private static readonly ConsultarSuspensaoCreditoBLL instance = new ConsultarSuspensaoCreditoBLL();

        private ConsultarSuspensaoCreditoBLL()
        {
        }

        public static ConsultarSuspensaoCreditoBLL Instance
        {
            get
            {
                return instance;
