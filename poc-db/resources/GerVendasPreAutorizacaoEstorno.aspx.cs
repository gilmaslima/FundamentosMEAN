...
{
    public partial class GerVendasPreAutorizacaoEstorno : PageBaseDataCash
    {
        #region [ Propriedades ]
        ...
        /// <summary>
        /// Volta para a página inicial do Gerenciamento de Vendas - Pré-Autorização - Estorno
        /// </summary>
        protected void btnVoltar_Click(object sender, EventArgs e)
        {
            base.Redirecionar("GerVendasPreAutorizacaoEstorno.aspx");
        }
        ...
        {
            using (Logger Log = Logger.IniciarLog("Pré-Autorização - Estorno - Continuar"))
            {
                try
                {
                    ...
                    {
                        ltNSUConfirmacao.Text = this.DadosTransacao.NSU;
                        ltTIDConfirmacao.Text = tid;
                        ltNroAutorizacaoConfirmacao.Text = this.DadosTransacao.AuthCode;
                        ltDataTransacaoConfirmacao.Text = txtDataTransacao.Text;
        ...
        {
            using (Logger Log = Logger.IniciarLog("Pré-Autorização - Estorno - Confirmar"))
            {
                try
                {
                    Int32 pv = this.SessaoAtual.CodigoEntidade;
                    ...
                    this.Retorno = new Negocio.Gerenciamento().ExecutarEstornarPre(pv, tid);
                    ...
                    ltValidadePreComprovante.Text = this.DadosTransacao.ValidadePreAutorizacao.ToString("dd/MM/yyyy");
                    ...
                    ltDataEstornoComprovante.Text = this.Retorno.Time.HasValue ? this.Retorno.Time.Value.ToString("dd/MM/yyyy") : "-";
                    ltHoraEstornoComprovante.Text = this.Retorno.Time.HasValue ? this.Retorno.Time.Value.ToString("HH:mm") : "-";
        ...
        protected TabelaExportacao ucAcoes_ObterTabelaExportacao()
        {
            ...
            {
                Titulo = String.Format("Estornar Pré-Autorização - Comprovante ({0} - {1})",
                ...
                Registros = new List<Tuple<String, String>>(new[] {
                    ...
                    new Tuple<String, String>("Validade da Pré", this.DadosTransacao.ValidadePreAutorizacao.ToString("dd/MM/yyyy")),
                    ...
                    new Tuple<String, String>("Data do Estorno", 
                        this.Retorno.Time.HasValue ? this.Retorno.Time.Value.ToString("dd/MM/yyyy") : "-"),
                    new Tuple<String, String>("Hora do Estorno", 
