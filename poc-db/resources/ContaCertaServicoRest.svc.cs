...
namespace Redecard.PN.DadosCadastrais.Servicos
{
    ...
    /// Serviço Conta Certa
    /// </summary>
    public class ContaCertaServicoRest : ServicoBase, IContaCertaServicoRest
    {
        ...
        public TerminalContaCertaListRest VerificaTerminalContaCerta(List<Servicos.FilialTerminais> filiais)
        {
            using (Logger Log = Logger.IniciarLog("Servico Conta Certa - VerificaTerminalContaCerta"))
            {
                ...
                try
                {
                    TerminalContaCertaListRest retorno;
                    ...
                    retorno = new TerminalContaCertaListRest
                    {
                        Itens = filiais != null ? filiais.ToArray() : null,
