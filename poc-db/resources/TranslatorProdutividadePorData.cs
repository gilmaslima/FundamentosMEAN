...
{
    /// <summary>
    /// Este componente publica a classe TranslatorProdutividadePorData, e expõe métodos para traduzir os dados de produtividade por data, oriundos do webservice
    /// </summary>
    public class TranslatorProdutividadePorData
    {
        /// <summary>
        /// Este método é utilizado para traduzir os dados de produtividade por data, oriundos do webservice 
        /// </summary>
        /// <param name="from"></param>
        /// <returns></returns>
        public static ProdutividadePorData TranslateProdutividadePorDataWSProdutividadePorDataBusiness(recordByDate from)
        {
        ...
        /// <summary>
        /// Este método é utilizado para traduzir os dados de produtividade por data para dados por data, oriundos do webservice
        /// </summary>
        /// <param name="from"></param>
        /// <returns></returns>
        public static recordByDate TranslateProdutividadePorDataBusinessProdutividadePorDataWS(ProdutividadePorData from)
        {
