...
{
    public sealed class GerenciamentoMotivoContatoOuvidoriaToolPart : ToolPart
    {
        ...
        // Controles ToolPart
        private TextBox txtMotivosContato;
        ...
        public GerenciamentoMotivoContatoOuvidoriaToolPart(IValidacao<string> validador)
        {
            if (validador == null)
        ...
        {
            SumarioValidacao resultadoValidacao = this.validador.Validar(this.txtMotivosContato.Text.Trim());

            if (resultadoValidacao.Valido)
                this.WebPart.MotivosContato = this.txtMotivosContato.Text.Trim();
            else
            {
                this.WebPart.Page.ClientScript.RegisterStartupScript(typeof(Page), "_erroValidacaoMotivosContato", string.Format("alert('{0}');", MontadorMensagemErroUtil.Montar(resultadoValidacao, GerenciamentoMotivoContatoOuvidoriaToolPart.cabecalhoInstrucaoCorrecao), true));
                this.CancelChanges();
            }
        }
        ...
        /// (Parent Container)
        /// </summary>
        private FormularioContatoComOuvidoria WebPart
        {
            get
            {
                return this.ParentToolPane.SelectedWebPart as FormularioContatoComOuvidoria;
            }
        }
        ...
        protected override void CreateChildControls()
        {
            ...
            this.ltlInstrucao = new LiteralControl(GerenciamentoMotivoContatoOuvidoriaToolPart.mensagemInstrucao);
