...
{
    /// <summary>
    /// UserControl do Box Serasa
    /// </summary>
    public partial class Serasa : BaseUserControl
    {
        #region [ Controles ]
        ...
        private Int32 Consultar(Guid guid, BuscarDados dados, Int32 pagina, Int32 tamanhoPagina)
        {
            ...
            var registros = default(List<WAExtratoServicosServico.Serasa>);
            ...
            using (Logger log = Logger.IniciarLog("Relatório de Serviços - Serasa"))
            {
                try
                {
                    using (var contexto = new ContextoWCF<HISServicoWA_Extrato_ServicosClient>())
                        registros = contexto.Cliente.ConsultarSerasa(
