...
namespace Redecard.PN.Comum.Enumerador
{
    /// <summary>
    ...
    ///     10	Usuário Aguardando confirmação do Master - Criação de usuário
    ///     11	Resposta da identificação positiva pendente
    ///     12	Usuário Aguardando Definição de Senha
    ///     100	Entidade Ativa
    ...
    public enum Status
    {
        ...
        /// <summary>
        /// Usuário Aguardando Definição de Senha
        /// </summary>
        [Description("Resposta da confirmação positiva pendente")]
        UsuarioAguardandoDefinicaoSenha = 12,
