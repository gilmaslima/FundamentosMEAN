...
{
	/// <summary>
	/// Disponibiliza o controle de download Html.
	/// </summary>
	internal class MenuAcaoDownloadHtml : WebControl, INamingContainer, IPostBackEventHandler
    {
        public MenuAcaoDownloadHtml(EventHandler click, String clientClick)
            : base(HtmlTextWriterTag.A)
        {
            this.ID = "btnDownloadHtml";
            this.Click = click;
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            String urlImagem = "/sites/fechado/Style%20Library/pt-br/Redecard/Img/redeareafechada-facelift/html.png";
            String texto = "download em HTML";
