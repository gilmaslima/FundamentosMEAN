...
namespace Redecard.PN.OutrasEntidades.SharePoint.WebParts.Komerci.RedirecionaKomerci
{
    ...
    public class RedirecionaKomerci : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/OutrasEntidades_Komerci/RedirecionaKomerci/RedirecionaKomerciUserControl.ascx";
