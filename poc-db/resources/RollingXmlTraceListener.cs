...
using Redecard.PN.Comum.TraceListeners;
    ...
    public class RollingXmlTraceListener : XmlTraceListener
    {
                                       ...
                                       object data)
        {
            ...
            {                
                ...
                if (logEntry.Parametros != null && !(logEntry.Parametros is String))
                    logEntry.Parametros = Logger.Serializar(logEntry.Parametros);

                data = TraceRecord.Convert(logEntry);
            }
