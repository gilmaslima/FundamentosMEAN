...
namespace Redecard.Portal.Aberto.WebParts.ListagemDicas
{
    ...
    public class ListagemDicas : System.Web.UI.WebControls.WebParts.WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/Redecard.Portal.Aberto.WebParts/ListagemDicas/ListagemDicasUserControl.ascx";
