...
using System.Linq;
using Rede.PN.DadosCadastraisMobile.SharePoint;
...
{
    public partial class ConfirmacaoPositivaMobUserControl : UserControlBase
    {
        ...
        /// </summary>
        protected ConfirmacaoPositivaResponsivo CpCriacaoAcesso { get { return (ConfirmacaoPositivaResponsivo)cpCriacaoAcesso; } }
        ...
        private void ExibirErro(String fonte, Int32 codigo, String titulo, String urlVoltar)
        {
            ...
            if (String.IsNullOrEmpty(urlVoltar))
            {
                ...
                QdAvisoConfirmacaoPositiva.CarregarMensagem(titulo, mensagem, false, QuadroAvisosResponsivo.IconeMensagem.Erro);
            }
            else
            {
        ...
        private void RedirecionaPasso4()
        {
            using (Logger log = Logger.IniciarLog("Redireciona para o Passo 4 de Conclusão de criação de usuário"))
            {
                try
                {
                    String urlConclusao = String.Format("{0}/Paginas/Mobile/CriacaoUsrConclusao.aspx", base.web.ServerRelativeUrl);
