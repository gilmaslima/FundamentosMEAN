...
{
    public class ConsultarSaldosemAbertoVSAMBLL : AbstractPesquisaComTotalizadorBLL<DadosConsultaSaldosEmAbertoDTO, BasicDTO, TotalizadorPorBandeiraSaldosEmAbertoDTO>
    {
        private static readonly ConsultarSaldosemAbertoVSAMBLL instance = new ConsultarSaldosemAbertoVSAMBLL();

        private ConsultarSaldosemAbertoVSAMBLL()
        {
        }

        public static ConsultarSaldosemAbertoVSAMBLL Instance
        {
            get
            {
                return instance;
        ...
        protected override RetornoPesquisaComTotalizadorDTO<BasicDTO, TotalizadorPorBandeiraSaldosEmAbertoDTO> ExecutarPesquisa(out StatusRetornoDTO statusRetornoDTO, DadosConsultaSaldosEmAbertoDTO envio)
        {
            ...
            ConsultarSaldosEmAbertoDTO itens = ag.ConsultarSaldosemAbertoVsam(out statusRetornoDTO, envio);
